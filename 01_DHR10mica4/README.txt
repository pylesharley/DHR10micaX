...
In DHR10_on_mica4_surface.pdb these models are combined to show how making alanine subsititions in DHR10 allows the negative glutamate residues to interact with the postive K+ ions. Global prediction of the binding mode is not done during this step (see /03_DHR10mica18_on_mica001_Ksublayer/3a_globabl_docking_on_potassium_sublattice/)
